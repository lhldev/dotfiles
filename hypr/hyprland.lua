...
local clipboardHistory = "cliphist"
...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("wl-paste --type text --watch " .. clipboardHistory .. " store")
	hl.exec_cmd("wl-paste --type image --watch " .. clipboardHistory .. " store")
end)
